function CharaterLength({ charaterLength, setCharaterLength }) {
    return (
        <section>
            <div className="flex items-center justify-between">
                <h2 className="md:text-500">Character Length</h2>
                <span className="text-600 text-green md:text-700">{charaterLength}</span>
            </div>
            <div className="relative mb-8 mt-2 flex h-[1.75rem] items-center md:mt-4">
                <div className="relative flex w-full">
                    ...
                    <span
                        ...
                        style={{ width: `${charaterLength * 4.95}%` }}
                    ></span>
                    <input
                        ...
                        onChange={(event) => setCharaterLength(event.target.value)}
                        type="range"
                        min="0"
                        max="20"
                        value={charaterLength}
                        autoComplete="off"
                    />
                </div>
            </div>
